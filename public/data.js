...
const links = {
  ...
  whatsApp:
    "https://api.whatsapp.com/send?phone=50376152630&app=facebook&entry_point=page_cta",
};
...
const goals = {
  mission: {
    ...
    info: "Proveer servicios de evaluación con el más alto rigor técnico y ético, garantizando la objetividad en los resultados para fortalecer el marco de toma de decisiones de nuestros usuarios. Nos comprometemos con la mejora institucional y el cumplimiento de estándares nacionales para asegurar la excelencia en cada proceso",
  },
  vission: {
...
const services = [
  ...
  },
  {
    ...
    content:
      "Comprabación que números de motor, y chasis sean iguales que tu tarjeta de circulación",
  },
  {
    id: uuidv4(),
    number: "03",
    ...
    content:
      "Revisión y diagnóstico por medio de escáner de componentes electrónicos o eléctricos; del sistema de refrigeración o aire acondicionado.",
  },
  {
    id: uuidv4(),
    number: "04",
  ...
  },
  {
    ...
    title: "Motor",
    content:
      "Revisión de niveles y ruidos, pruebas de compresión en cilindros de motor.",
  },
  {
    id: uuidv4(),
    number: "06",
    title: "Carrocería",
    content:
      "Verificación de las condiciones estéticas y estructurales, entregamos cuatro fotografías o más en caso que se identifique daño severo estructural en chasis o carrocería.",
  },
  {
    id: uuidv4(),
    number: "07",
...
export { links, alliedCompanies, goals, services };
