    ...
    <>
      <header className="home-header">
            ...
            <>
              ...
              <AnimatePresence exitBeforeEnter>
                {showNavbar && (
                  ...
                  >
                    <hr />
                    <a href={facebook} className="btn btn--social facebook">
                      Facebook
                      <FaFacebookSquare className="btn--icon" />
                    </a>
                    <a href={instagram} className="btn btn--social instagram">
                      Instagram
                      <FaInstagram className="btn--icon" />
                    </a>
                    <a href={instagram} className="btn btn--social whatsapp">
                      WhatsApp
        ...
        <section className="header__title container">
          ...
          <h2>
            Revisa el auto que quieras <br /> comprar.
          </h2>
        </section>

        {windowWidth > 768 && (
          <nav className="container social__media">
            <a href={facebook} className="social__media-link">
              <FaFacebookSquare />
            </a>
            <a href={instagram} className="social__media-link">
              <FaInstagram />
            </a>
            <a href={whatsApp} className="social__media-link">
              <FaWhatsapp />
            </a>
          </nav>
        )}
